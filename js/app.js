...
function renderSiswa(){
    ...
    $('btnCetakDaftar')?.addEventListener('click',()=>{
        ...
        if(judul){judul.innerHTML='<h5>DAFTAR NAMA SISWA '+(mdr?H(mdr.nama):'MA KKMA 04 JEMBER')+'</h5><p class="small">Kecamatan Sukowono, Kabupaten Jember</p>';}
